...
class DesktopApp(tk.Tk):
    def __init__(self):
        ...
        self.menu.add_command(label="Sales", command=self.show_sales)
        self.menu.add_command(label="Stock", command=self.show_stock)
    ...
    def show_main_app(self):
        ...
        self.show_sales()  # Show home by default after login.
